...
int ScrollBar::extent() const
{
    ...
    styleOptionSlider.init(this);
    styleOptionSlider.subControls = QStyle::SC_None;
    styleOptionSlider.activeSubControls = QStyle::SC_None;
    styleOptionSlider.orientation = orientation();
    styleOptionSlider.minimum = minimum();
    styleOptionSlider.maximum = maximum();
    styleOptionSlider.sliderPosition = sliderPosition();
    styleOptionSlider.sliderValue = value();
    styleOptionSlider.singleStep = singleStep();
    styleOptionSlider.pageStep = pageStep();
    styleOptionSlider.upsideDown = invertedAppearance();
    if (orientation() == Qt::Horizontal)
        styleOptionSlider.state |= QStyle::State_Horizontal;

    return style()->pixelMetric(QStyle::PM_ScrollBarExtent, &styleOptionSlider, this);
}
